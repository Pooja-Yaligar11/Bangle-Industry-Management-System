...
<?php include('sidebar.php');?>
  ...
  <tr>
    ...
    <td>&nbsp;<a href="customer_order_details_delete.php?cod_id=<?php echo $row['customer_order_details_id'];?>"onClick="return confirm('Are you sure want to delete')" class="btn btn-danger">Delete</a></td>
  </tr>
  <?php
  }
  ?>
