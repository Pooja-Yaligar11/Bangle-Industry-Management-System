...
<?php include('sidebar.php');?>
  ...
  <tr>
    ...
    <td>&nbsp;<a href="vendor_payment_edit.php?vp_id=<?php echo $row['vendor_payment_id'];?>" class="btn btn-info">Edit</a></td>
    <td>&nbsp;<a href="vendor_payment_delete.php?vp_id=<?php echo $row['vendor_payment_id'];?>"onClick="return confirm('Are you sure want to delete')" class="btn btn-danger">Delete</a></td>
  </tr>
  <?php
  }
  ?>
