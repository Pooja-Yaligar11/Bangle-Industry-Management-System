...
<?php include('sidebar.php');?>
  ...
  $sql=" select * from expenditure  where given_date between '$date1' and '$date2'";
  ...
  <tr>
    ...
    <td>&nbsp;<a href="expenditure_edit.php?ex_id=<?php echo $row['expenditure_id'];?>" class="btn btn-info">Edit</a></td>
    <td>&nbsp;<a href="expenditure_delete.php?ex_id=<?php echo $row['expenditure_id'];?>"onClick="return confirm('Are you sure want to delete')" class="btn btn-danger">Delete</a></td>
  </tr>
  <?php
  }
  ?>
