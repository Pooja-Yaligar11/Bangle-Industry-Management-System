...
<?php include('sidebar.php');?>
  ...
  <tr>
    ...
    <td>&nbsp;<a href="customer_details_edit.php?c_id=<?php echo $row['customer_id'];?>" class="btn btn-info">Edit</a></td>
    <td>&nbsp;<a href="customer_details_delete.php?c_id=<?php echo $row['customer_id'];?>"onClick="return confirm('Are you sure want to delete')" class="btn btn-danger">Delete</a></td>
  </tr>
  <?php
   }
   ?>
