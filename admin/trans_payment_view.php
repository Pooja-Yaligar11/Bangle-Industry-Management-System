...
<?php include('sidebar.php');?>
  ...
  <tr>
    ...
    <td>&nbsp;<a href="trans_payment_edit.php?tp_id=<?php echo $row['transportation_payment_id'];?>" class="btn btn-info">Edit</a></td>
    <td>&nbsp;<a href="trans_payment_delete.php?tp_id=<?php echo $row['transportation_payment_id'];?>"onClick="return confirm('Are you sure want to delete')" class="btn btn-danger">Delete</a></td>
  </tr>
  <?php
  }
  ?>
