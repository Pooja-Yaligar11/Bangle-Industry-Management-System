...
<form name="formID" ID="formID" method="post" action="customer_order_master_insert.php">
 <table class="table table-striped table-bordered table-hover"    >
    ...
    <tr>
      ...
      <td><input name="qnt" type="text" id="qnt" size="10"  class="validate[required,custom[onlyNumber]]"></td>
 ...
 <table class="table table-bordered table-hover tablesorter"  id="demo-dtable-01"  >
	...
	$gtotal=0;
		...
		$customer_order_details_id=$row3["customer_order_details_id"];
		$pid=$row3["product_id"];
    ...
    <tr>
      <td>&nbsp;<?php echo $slno; ?></td>
	   <td>&nbsp;<img src="../upload/<?php echo $row3["product_image"]; ?>" width="160" height="180"></td>
      <td>&nbsp;<?php echo $pname; ?></td>
    
      <td>&nbsp;<?php echo $qnt; ?></td>
    
      <td>&nbsp;<a href="customer_order_details_delete.php?pmid=<?php echo $pmid; ?>&cod_id=<?php echo $customer_order_details_id; ?>" title="<?php echo $slno; ?>" >Delete</a></td>
    </tr>
