...
<input type="hidden" name="c_id" value="<?php echo $row['customer_id'];?>">
     ...
     <table width="423" height="340" border="0" align="center">
    <tr>
      <td>Company Name </td>
    ...
    <tr>
      <td>Company Code </td>
      <td><input name="customer_code" type="text" class="form-control validate[required]" id="customer_code" value="<?php echo $row['customer_code'];?>" readonly=""></td>
    </tr>
    <tr>
